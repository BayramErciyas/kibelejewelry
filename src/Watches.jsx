...
const Watches = () => {
  ...
  const initialProducts = Array.from({ length: 12 }).map((_, i) => ({
    id: `watch-${i}`,
    name: lang === 'TR' ? `PREMIUM SAAT SERİSİ W-${(i + 101)}` : `PREMIUM WATCH SERIES W-${(i + 101)}`,
    price: 24900 + (i * 500), // Sıralama testi için değişken fiyat
    date: i,
    img: `https://picsum.photos/seed/watch-${i}/800/1067`
  }));
  ...
  return (
    <div className="watches-page-wrapper">
      <div className="watches-page-fluid">
        ...
        <div className={`side-panel ${activePanel ? 'open' : ''}`}>
          ...
          <div className="panel-content">
            {activePanel === 'filter' ? (
              ['KAYIŞ TİPİ', 'KASA ÇAPI', 'MEKANİZMA', 'FİYAT'].map(item => (
        ...
        <style>{`
          .watches-page-wrapper { width: 100%; min-height: 100vh; }
          .watches-page-fluid { width: 100%; background: #fff; }
          ...
          @media (max-width: 768px) {
            .filter-section-container { padding-top: 20px; }
